...
import com.demo.date.JacksonUtils;
...
import org.apache.pulsar.shade.org.apache.http.client.utils.URIBuilder;
...
public class HttpClientUtils {
     ...
     * @throws Exception
     */
    public static HttpClientResult doPost(String url, Map<String, String> headers, Object object) throws Exception {
        // 创建httpClient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
    ...
    private static void packageBody(Object object, HttpEntityEnclosingRequestBase httpPost) throws Exception {
        // 封装请求参数
        if (object != null) {
            // 设置到请求的http对象中
            final StringEntity stringEntity = new StringEntity(JacksonUtils.obj2json(object), ENCODING);
